...
public class ProjectFile {
    ...
    public ProjectFile(Drill drill, String archivePath, ArrayList<SyncTimeGUI.Pair> timeSync, Float startDelay, HashMap<Integer, RFTrigger> count2RFTrigger, ArrayList<Integer> ids, ArrayList<SelectionGroupGUI.SelectionGroup> selectionGroups) {
        this.drill = drill;
