...
public class FootballFieldBackground extends JPanel {
    ...
    private final BufferedImage dummyImage = new BufferedImage(2200, 1157, BufferedImage.TYPE_INT_ARGB);
    ...
    public void paintComponent(Graphics g) {
        ...
        if ((this.fieldHeight != getHeight() && heightBound) ||
            this.fieldWidth != getWidth() && !heightBound) {
